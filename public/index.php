...
if(isset($_SESSION['validfullname']) && isset($_SESSION['validusername']) && 
isset($_SESSION['validemail']) && isset($_SESSION['validpassword']) && 
!empty($_SESSION['validfullname']) && !empty($_SESSION['validusername']) && 
!empty($_SESSION['validemail']) && !empty($_SESSION['validpassword'])) {
...
<div style=" width:800px; padding:10px;-webkit-border-radius: 5px;
	-moz-border-radius: 5px;border-radius: 5px; font-size:13px;" 
	id="vasplus_programming_blog_wrapper">

<div class="" align="left" style="width:730px; float:left;font-family:Verdana, 
Geneva, sans-serif; font-size:16px; font-weight:bold;">Welcome 
<?php echo $_SESSION['validfullname']; ?>
</div>

<div style="width:70px;float:left;" align="right"><span class="ccc">
<a href="login/logout.php"><font color="#3300FF">Logout</font></a>
</span>
</div>
...
<div class="vpb_lebels_fields" align="left"><?php echo $_SESSION['validfullname']; ?>
</div>
<br clear="all"><br clear="all">

<div class="vpb_lebels" style="padding:0px;" align="left">Your Username:</div>
<div class="vpb_lebels_fields" align="left"><?php echo $_SESSION['validusername']; ?>
</div>
<br clear="all"><br clear="all">

<div class="vpb_lebels" style="padding:0px;" align="left">Email Address:</div>
<div class="vpb_lebels_fields" align="left"><?php echo $_SESSION['validemail']; ?>
</div>
<br clear="all"><br clear="all">
